...
This **Restricted Countries List** defines the jurisdictions in which the holding, trading, and use of the PNJC token (hereinafter referred to as the "Token") are permitted, restricted, or completely prohibited. The User bears full and exclusive responsibility for compliance with the laws of their country.
...
### 2.3. Dynamic Nature of the List

Cryptocurrency laws may change at any time. This List is current as of the date of publication (July 25, 2026) and may be amended without prior notice. The User is obligated to regularly check the current version of the List on the Project's official website.

### 2.4. Legal Disclaimer

This List does not constitute legal advice. If you have questions, it is recommended that you consult a qualified attorney specialising in cryptocurrency law in your jurisdiction.
...
- It is recommended to use only decentralised platforms (DEX, Uniswap V2) and non-banking methods for depositing and withdrawing funds.
...
### 6.1. Countries with Undetermined Status
...
### 6.2. Recommendation for All Users
...
## 8. PNJC Token Features Supporting Regulatory Compliance

| Feature | Description |
| :--- | :--- |
| **Fixed Supply** | No inflation, no minting. |
...
| **Verified Code** | PolygonScan (Exact Match). |
...
## 10. Amendments to the List

### 10.1. Dynamic Nature of Regulation
...
| **FATF Compliance Framework** | International AML/CFT alignment. |
| **Georgia Regulatory Assessment** | Georgian jurisdiction analysis. |
| **MiCA Assessment** | EU regulatory compliance. |
| **Legal Disclaimer** | Legal compliance and risk disclosure. |
| **Risk Disclosure** | Comprehensive risk factors. |

---

## 12. Appendix: Country Confirmation Template
...
This Restricted Countries List has been developed to ensure maximum transparency and to inform users about regulatory restrictions related to the holding and trading of PNJC.
...
This Restricted Countries List is provided for informational purposes and does not constitute legal advice.

Specific regulatory obligations may depend on:
