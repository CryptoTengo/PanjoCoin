...
PanjoCoin is a community-driven ERC-20 token operating on the Polygon blockchain, designed to support:
...
Support responsible blockchain innovation;
...
The project monitors applicable requirements related to:
...
Blockchain transparency practices.
...
The project evaluates factors commonly considered under the SEC Howey Test, including:
...
PNJC is not intended to provide:
...
Activities Not Currently Provided

PNJC does not currently operate:
...
Potential regulated activities may include:

Custody;
Exchange services;
Transfer services;
Financial services connected to virtual assets.

If PNJC expands into regulated activities, the project will evaluate:
...
Future DAO mechanisms may include:
...
Georgian virtual asset regulation;
...
Regulatory requirements may vary by jurisdiction and may change over time.
