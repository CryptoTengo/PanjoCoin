PNJC TERMS OF USE
PANJOCOIN (PNJC) — TERMS OF USE 
Effective Date: July 9, 2026
________________________________________
These Terms of Use (hereinafter referred to as the "Terms") govern the access and use of the website www.cryptotengo.com (hereinafter referred to as the "Website"), related services, as well as interaction with the PNJC token (hereinafter referred to as the "Token") and the PanjoCoin ecosystem (hereinafter referred to as the "Project").
Please read these Terms carefully before using the Website, Services, or acquiring the Token. By using the Website, Services, or acquiring the Token, you confirm that you fully understand and unconditionally accept all provisions of these Terms, and that you agree to the Legal Disclaimer v1.1, Whitepaper v1.1, and Tokenomics v1.1, which are integral parts of this document.
...
•	"Project" — PanjoCoin (PNJC), a decentralized ecosystem built on the Polygon PoS blockchain, including the PNJC token, the Website, smart contracts, and planned services (ONE+ gaming platform, ClownCare Bridge, DAO, etc.).
•	"Token" — the PNJC digital asset, conforming to the ERC-20 standard, issued on the Polygon PoS blockchain, as described in Whitepaper v1.1 and Tokenomics v1.1.
•	"Website" — the website located at www.cryptotengo.com, as well as all its subdomains and related pages.
...
•	"Smart Contract" — programmable code deployed on the Polygon PoS blockchain that implements the logic of the Token, liquidity lock, and other modules.
•	"DEX" — a decentralized exchange (e.g., Uniswap V3) where Token trading occurs.
•	"DAO" — a decentralized autonomous organization that will be created in the future to govern the Project (code ready; deployment scheduled for Q4 2026).
•	"Disclaimer" — the PNJC Legal Disclaimer v1.1, which is an appendix to these Terms.
•	"Whitepaper" — the document "PanjoCoin (PNJC) — Whitepaper v1.1," describing the technical and economic aspects of the Project.
•	"Tokenomics" — the document "PanjoCoin (PNJC) — Tokenomics v1.1," describing the distribution and circulation model of the Token.
________________________________________
...
•	you have reviewed Whitepaper v1.1, Tokenomics v1.1, and the Disclaimer v1.1 and agree with their content.
2.2.
...
•	acquisition, holding, transfer, and other operations with the PNJC Token on and off DEX.
3.2.
...
5. THE PNJC TOKEN
5.1.
The PNJC Token is a utility digital asset that provides access to current and future ecosystem services. The Token is not a security and does not confer rights to income, dividends, a share in the Project's assets, or management (except for future DAO votes, which do not confer property rights). A detailed analysis of the Token's status is provided in the Legal Disclaimer v1.1, Section 2 (Howey Test).
5.2.
...
5.5.
Liquidity lock (50% of total supply) will be executed through the immutable PNJCLiquidityLockerV3 contract for 12 months (code ready; deployment scheduled; exact date to be announced at deployment).
________________________________________
6. PROHIBITED ACTIVITIES
The User is strictly prohibited from:
6.1.
Using the Website, Services, or Token in any jurisdiction where this is expressly prohibited by law. The list of countries with absolute prohibition is contained in the "Restricted Countries List v1.1" document (Afghanistan, Algeria, Bangladesh, Bolivia, China, Egypt, Iraq, Morocco, Nepal, Qatar, Tunisia, North Macedonia). Citizens and residents of these countries are prohibited from holding, trading, or mining PNJC.
6.2.
...
•	errors, omissions, failures, delays, or interruptions in the operation of the Polygon blockchain, Uniswap V3 DEX, or other external systems;
...
•	your violation of these Terms, the Disclaimer v1.1, or other Project documents;
...
________________________________________
APPENDIX: REFERENCES TO DOCUMENTS
