...
## 🎯 Introduction
Welcome to the PanjoCoin open‑source project! We are building a transparent, community‑driven blockchain ecosystem on Polygon. Your contributions — whether code, documentation, design, testing, or feedback — are invaluable to us.
...
## 📜 Code of Conduct
We are committed to providing a welcoming and harassment‑free experience for everyone. Please read and follow our Code of Conduct. In short:
...
A code editor (VS Code recommended with Solidity and Prettier extensions)
...
cp .env.example .env   # (if exists) and fill in your keys
### 🤝 How to Contribute
We welcome all types of contributions:

Area	Examples
Code	Smart contracts, tests, deployment scripts, helper libraries
Documentation	Whitepaper, API docs, README, inline comments, guides
...
### 📏 Coding Standards
Solidity
Version: pragma solidity ^0.8.34;
...
Contracts, libraries, structs, events: CapWords
...
Avoid block.timestamp for critical logic – use time‑locked mechanisms where possible.
...
Mentioned in our Contributors page.

Invited to become Maintainers or Core Team members.

Eligible for PNJC rewards (subject to DAO approval in the future).
