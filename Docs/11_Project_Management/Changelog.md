...
Keep a Changelog
Semantic Versioning (SemVer) where applicable
[Unreleased]
Added
...
Features or documentation scheduled for removal.

Removed

Items removed from the project.
...
Security-related improvements or advisories.
